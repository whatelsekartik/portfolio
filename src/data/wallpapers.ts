...
// and it is picked up automatically. If no file exists this stays empty.
const customFiles = import.meta.glob("../assets/wallpaper.{png,jpg,jpeg,webp}", {
  eager: true,
  query: "?url",
  import: "default",
}) as Record<string, string>;
const customUrl = Object.values(customFiles)[0];
...
export const defaultWallpaperId = customUrl ? "custom" : desktop.defaultPattern;
